...
class MaskedTransformerEncoderLayer(nn.Module):
    ...
    *args.encoder_normalize_before* to ``True``.
    ...
    def __init__(self, args):
        ...
        self.self_attn_layer_norm = MaskedLayerNorm_select(self.embed_dim, args.mask_layernorm_type)
        ...
        self.final_layer_norm = MaskedLayerNorm_select(self.embed_dim, args.mask_layernorm_type)
    ...
    *args.decoder_normalize_before* to ``True``.
    ...
    def __init__(
        ...
        if no_encoder_attn:
            ...
            self.encoder_attn_layer_norm = MaskedLayerNorm_select(self.embed_dim, args.mask_layernorm_type)
